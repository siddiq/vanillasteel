...
def test_get_all_products():
    ...
    with patch("app.products.product_api.fetch_all_products", return_value=mock_products):
...
def test_get_product_by_product_number():
    ...
    with patch("app.products.product_api.fetch_product_by_product_number", return_value=mock_product):
...
def test_get_product_by_product_number_not_found():
    with patch("app.products.product_api.fetch_product_by_product_number", return_value=[]):
