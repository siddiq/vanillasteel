...
from app.products.products_service import fetch_all_products, fetch_product_by_product_number
...
def test_get_all_products():
    ...
    with patch("app.products.products_api.fetch_all_products", return_value=mock_products):
...
def test_get_product_by_product_number():
    ...
    with patch("app.products.products_api.fetch_product_by_product_number", return_value=mock_product):
...
def test_get_product_by_product_number_not_found():
    with patch("app.products.products_api.fetch_product_by_product_number", return_value=[]):
